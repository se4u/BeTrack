 ...
 */
public class UtilsCustomListView extends ListView {
    ...
    public UtilsCustomListView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }

    public UtilsCustomListView(Context context, AttributeSet attrs, int defStyle)
    {
